...
exports.userSchema = zod_1.z.object({
    ...
    authProvider: zod_1.z.enum(['local', 'auth0']).openapi({ description: 'auth provider of the user' }),
    ...
    favoritsProduct: zod_1.z.array(zod_1.z.string()).openapi({ description: 'favoritsProduct of the user' }),
    pymemtId: zod_1.z.string().openapi({ description: 'pymemtId of the user' }),
    shoppingCartId: zod_1.z.string().openapi({ description: 'shoppingCartId of the user' }),
});
