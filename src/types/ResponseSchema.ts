...
export const SuccessResponseSchema = z.object({
    ...
    message: z.string().openapi({ description: "A message describing the result of the operation" }),
    data: z.any().optional().openapi({ description: "Optional data returned from the operation" }),
    errors: z.string().optional().openapi({ description: "Optional error messages if the operation failed" }),
});
